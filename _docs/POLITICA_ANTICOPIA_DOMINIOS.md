...
├── 3-ejercicios/          # Ejercicios que requieren adaptación al dominio
├── 4-asignacion-dominios/ # ⚠️ PRIVADA - Solo instructor
│   ├── .gitkeep
│   ├── aprendiz-001.md    # María → Restaurante
│   ├── aprendiz-002.md    # Pedro → Veterinaria
│   ├── aprendiz-003.md    # Ana → Gimnasio
│   └── ...
├── 5-recursos/            # Referencias generales
...
### Archivo: `aprendiz-XXX.md`

```markdown
# Asignación Personal - Aprendiz XXX
...
3. Crear archivos individuales en 4-asignacion-dominios/
...
✅ **Diversidad de implementaciones:** Cada proyecto es único  
...
// Lista de aprendices (nombres encriptados o IDs)
const learners = [
  { id: '001', name: '[CONFIDENCIAL]' },
  { id: '002', name: '[CONFIDENCIAL]' },
  // ...
];
...
function generateAssignmentFiles(assignments) {
  assignments.forEach((assignment) => {
    ...
    const filename = `aprendiz-${assignment.id}.md`;
    const filepath = path.join(
      __dirname,
      '../../bootcamp/semana-01/4-asignacion-dominios',
      filename
    );
...
Ver archivo completo en: `bootcamp/semana-XX/4-asignacion-dominios/TEMPLATE.md`
...
- ✅ Todos los dominios tienen **complejidad similar**
...
- `bootcamp/semana-01/4-asignacion-dominios/TEMPLATE.md` (plantilla)
- `bootcamp/semana-01/4-asignacion-dominios/README.md` (guía del instructor)

### Para los Aprendices

- `bootcamp/semana-XX/4-asignacion-dominios/aprendiz-XXX.md` (su asignación personal)
...
**📌 Nota Final:** Esta política se aplica desde la **Semana 1 hasta la Semana 9** del bootcamp bc-express. Todo el contenido educativo está diseñado para ser **genérico y adaptable** a cualquier dominio.
